...
import com.tuoheng.demo20.handler.TokenArgumentResolver;
import com.tuoheng.demo20.handler.YmlReturnValueHandler;
...
/**
 * 比起WebConfig02,向Bean对象MyRequestMappingAdapter新增了参数解析器和返回值处理器组件
 */
...
public class WebConfig03 {
    ...
    public TomcatServletWebServerFactory tomcatServletWebServerFactory(){
        return new TomcatServletWebServerFactory(8002);
    }
